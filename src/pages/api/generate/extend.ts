 ...
 * Returns 201 with GenerationResponseDTO for +10 extension of an existing generation.
 */
...
export const POST: APIRoute = async (context) => {
  ...
  try {
    ...
    if (message) {
      ...
      if (message === "BASE_GENERATION_NOT_FOUND") {
        return new Response(
          JSON.stringify({ error: { code: "NOT_FOUND", message: "Base generation not found or not accessible" } }),
